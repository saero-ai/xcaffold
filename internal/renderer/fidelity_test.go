		...
		ResourceScope: ast.ResourceScope{
			Agents: map[string]ast.AgentConfig{
				"fidelity-agent": {
					...
					Color:           "blue",
					InitialPrompt:   "hello",
					Skills:          ast.ClearableList{Values: []string{"fidelity-skill"}},
					Rules:           ast.ClearableList{Values: []string{"fidelity-rule"}},
					MCP:             ast.ClearableList{Values: []string{"fidelity-mcp"}},
					Assertions:      ast.ClearableList{Values: []string{"assert-something"}},
