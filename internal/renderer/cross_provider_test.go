...
// TestCrossProvider_Antigravity asserts that compiling for antigravity
// produces valid output files without panic or unexpected errors.
func TestCrossProvider_Antigravity(t *testing.T) {
	cfg, baseDir := crossProviderFixture(t)
