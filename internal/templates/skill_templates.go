...
func RenderXcaffoldSkillXCF(targets []string) string {
	...
	lines = append(lines, "",
		...
		"  ",
		"  3. **Read `xcf/references/` before setting fields.**",
		"     `xcf/references/agent.xcf.reference` and `xcf/references/skill.xcf.reference` are the",
		...
		"  "+fence,
		"  my-project/",
		"    scaffold.xcf              <- kind: project (targets, resource refs)",
		"    xcf/",
		"      agents/",
		...
		"  ",
		"  "+fence+"bash",
		"  cat xcf/references/agent.xcf.reference",
		"  cat xcf/references/skill.xcf.reference",
		"  "+fence,
		"  ",
		...
		"  "+fence,
		"  ",
		"  3. Register the resource in `scaffold.xcf`:",
		"  ",
		"  "+fence+"yaml",
		"  agents:",
		"    - developer",
		...
		"  ",
		"  "+fence+"yaml",
		"  # kind: project — scaffold.xcf at project root",
		"  kind: project",
		`  version: "1.0"`,
		`  name: "my-project"`,
		"  targets:",
