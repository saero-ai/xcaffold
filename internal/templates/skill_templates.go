...
func RenderXcaffoldSkillXCF(targets []string) string {
	...
	lines = append(lines, "",
		...
		"  - .xcaffold/schemas/agent-reference.md",
		"  - .xcaffold/schemas/skill-reference.md",
		"  - .xcaffold/schemas/rule-reference.md",
		"  - .xcaffold/schemas/workflow-reference.md",
		"  - .xcaffold/schemas/mcp-reference.md",
		"  - .xcaffold/schemas/hooks-reference.md",
		"  - .xcaffold/schemas/memory-reference.md",
		"  - .xcaffold/schemas/cli-cheatsheet.md",
		"---",
