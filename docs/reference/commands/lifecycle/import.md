...
|---|---|---|---|
| `--target` | string | (auto-detect) | Import from a specific provider: `antigravity`, `claude`, `copilot`, `cursor`, `gemini`. Without this flag, auto-detects all available providers. |
