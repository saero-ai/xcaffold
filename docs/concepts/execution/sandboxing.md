---
title: "Sandboxing"
description: "Runtime sandbox configuration via settings.sandbox — OS-level process isolation compiled to target platforms. xcaffold test and LLM-as-a-Judge evaluation are planned for a future release (Preview)."
---
...
> **Preview.** The evaluation simulation (`xcaffold test`) is planned for a future release.
