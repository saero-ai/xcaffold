...
| **Antigravity** | `.agents/` | `.agents/` | Flat Markdown agent definitions with YAML frontmatter; `hooks.json`; workspace `mcp_config.json`; `workflows/*.md` |
